%----------------------------------------------------------------------
%    File: CellSimplifiedModV4DruggedFINALFinal.al
% Problem: Equations of Motion for the migrating cell
%          run CellSimplifiedModV4DruggedFINALFinal.al
%----------------------------------------------------------------------
...
% 3rd-Order DMD
x8d = 7.00E-6 + (-1.40E-9)*T + ((1/2)*1.20E-12)*T^2 - ((1/3)*1.12E-16)*T^3 + ((1/4)*2.76E-21)*T^4
v8d = -1.40E-9 + ((1/1)*1.20E-12)*T - ((1/1)*1.12E-16)*T^2 + ((1/1)*2.76E-21)*T^3
a8d = ((1/1)*1.20E-12) - ((2/1)*1.12E-16)*T + ((3/1)*2.76E-21)*T^2
...
Input MA = 7.97E-16 kg, MB = 7.97E-16 kg
Input MC = 7.97E-16 kg, MD = 7.97E-16 kg
Input ME = 7.97E-16 kg, MF = 7.97E-16 kg
Input MG = 2.29E-11 kg

Input grav = 9.81 m/sec^2

Input IA3 = (1/12)*(7.97E-16)*(20E-6)^2 kg*m^2
Input IB3 = (1/12)*(7.97E-16)*(20E-6)^2 kg*m^2
Input IC3 = (1/12)*(7.97E-16)*(20E-6)^2 kg*m^2
Input ID3 = (1/12)*(7.97E-16)*(20E-6)^2 kg*m^2
Input IE3 = (1/12)*(7.97E-16)*(20E-6)^2 kg*m^2
Input IF3 = (1/12)*(7.97E-16)*(20E-6)^2 kg*m^2
...
save CellSimplifiedModV4DruggedFINALFinal.all
