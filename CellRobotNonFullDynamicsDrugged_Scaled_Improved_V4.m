%% |==============================================================================================|%
  %|      Filename: CellRobotNonFullDynamicsDrugged_Scaled_Improved_V4.m                          |%
  %|                                                                                              |%
...
%% ------------------------- Scaling Factors -------------------------
    ...
    TIME_SCALE = 23406.442;           % Scale time from [0,1] to [0,t_sim]
...
%% ------------------------- SIGMOIDAL FORCE INITIAL GUESS -------------------------
    ...
    Upsilon1_init = 42.97;
    Upsilon1_final = 36.45;
    
    Upsilon2_init = 53.56;
    Upsilon2_final = 36.76;
    
    Upsilon3_init = -66.10;
    Upsilon3_final = -32.32;
