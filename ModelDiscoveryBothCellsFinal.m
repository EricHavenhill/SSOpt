...
leg = legend('Non-treated $x_{d}$ ($\mu$m)','Drug-treated $x_{d}$ ($\mu$m)','Interpreter','latex','FontSize', font_size, 'Location', 'northwest');
...
figure(11)
plot(t_control,(10^6)*x_control-(10^6)*x_control(1,1)+7,'LineWidth',2,'Color',[0.2,0.5,0.8],'LineStyle','--') % off-blue dashed
hold on
plot(ts_control,(10^6)*SV_control(:,1)-(10^6)*SV_control(1,1)+7,'LineWidth',2,'Color',[0.2,0.5,0.8],'LineStyle','-') % off-blue solid
plot(t,(10^6)*x-(10^6)*x(1,1)+7,'LineWidth',2,'Color',[0.9,0.4,0.3],'LineStyle','--')   % off-red dashed
plot(ts,(10^6)*SV(:,1)-(10^6)*SV(1,1)+7,'LineWidth',2,'Color',[0.9,0.4,0.3],'LineStyle','-') % off-red solid
...
% Legend
leg = legend('Non-treated $x_{d}$','Non-treated $x_{d}$',...
             'Drug-treated $x_{d}$','Drug-treated $x_{d}$',...
             'Interpreter','latex','FontSize', font_size, ...
             'Location','northwest');

leg.Position(3) = leg.Position(3) * 1.1; % Increase width by 20%
