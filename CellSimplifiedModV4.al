%----------------------------------------------------------------------
%    File: CellSimplifiedModV4.al
% Problem: Equations of Motion for the migrating cell
%          run CellSimplifiedModV4.al
%----------------------------------------------------------------------
...
x8d = 7E-6 + (4.859E-9)*T - ((1/2)*6.759E-13)*T^2 + ((1/3)*4.0255E-17)*T^3 - ((1/4)*8.35139E-22)*T^4 
v8d = (4.859E-9) - ((1/1)*6.759E-13)*T + ((1/1)*4.0255E-17)*T^2 - ((1/1)*8.35139E-22)*T^3
a8d = -((1/1)*6.759E-13) + ((2/1)*4.0255E-17)*T - ((3/1)*8.35139E-22)*T^2
