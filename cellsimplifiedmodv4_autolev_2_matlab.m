function cellsimplifiedmodv4_autolev_2_matlab
SolveOrdinaryDifferentialEquations
% File  cellsimplifiedmodv4_autolev_2_matlab.m  created by Autolev 4.0 on Sat Mar 30 02:00:52 2024
...
global   U1 U2 U3 U4 U5 U6 Q1p Q2p Q3p Q4p Q5p Q6p Q7p Q8p Q9p U7p U8p U9p WCHECK1p A8D FB FD FF V8D X8D DETJ;
...
IA3                             =  1.162333333333334E-33;  % KG*M^2              Constant
IB3                             =  1.162333333333334E-33;  % KG*M^2              Constant
IC3                             =  1.162333333333334E-33;  % KG*M^2              Constant
ID3                             =  1.162333333333334E-33;  % KG*M^2              Constant
IE3                             =  1.162333333333334E-33;  % KG*M^2              Constant
IF3                             =  1.162333333333334E-33;  % KG*M^2              Constant
IG3                             =  8.840000000000001E-20;  % KG*M^2              Constant
KP                              =  1;                      % UNITS               Constant
KV                              =  2;                      % UNITS               Constant
...
MA                              =  3.487E-23;              % KG                  Constant
MB                              =  3.487E-23;              % KG                  Constant
MC                              =  3.487E-23;              % KG                  Constant
MD                              =  3.487E-23;              % KG                  Constant
ME                              =  3.487E-23;              % KG                  Constant
MF                              =  3.487E-23;              % KG                  Constant
MG                              =  4E-9;                   % KG                  Constant
...
FileIdentifier = fopen('cellsimplifiedmodv4_autolev_2_matlab.1', 'wt');   if( FileIdentifier == -1 ) error('Error: unable to open file cellsimplifiedmodv4_autolev_2_matlab.1'); end
fprintf( 1,             '%%       T             Q7             Q8             Q9             U7             U8             U9             FB             FD             FF            DETJ\n' );
fprintf( 1,             '%%     (SEC)          (RAD)         (METER)        (METER)        (UNITS)        (UNITS)        (UNITS)        (UNITS)        (UNITS)        (UNITS)        (UNITS)\n\n' );
fprintf(FileIdentifier, '%% FILE: cellsimplifiedmodv4_autolev_2_matlab.1\n%%\n' );
fprintf(FileIdentifier, '%%       T             Q7             Q8             Q9             U7             U8             U9             FB             FD             FF            DETJ\n' );
fprintf(FileIdentifier, '%%     (SEC)          (RAD)         (METER)        (METER)        (UNITS)        (UNITS)        (UNITS)        (UNITS)        (UNITS)        (UNITS)        (UNITS)\n\n' );
FileIdentifier = fopen('cellsimplifiedmodv4_autolev_2_matlab.2', 'wt');   if( FileIdentifier == -1 ) error('Error: unable to open file cellsimplifiedmodv4_autolev_2_matlab.2'); end
fprintf(FileIdentifier, '%% FILE: cellsimplifiedmodv4_autolev_2_matlab.2\n%%\n' );
...
A8D = -6.759E-13 + 8.051E-17*T - 2.505417E-21*T^2;
X8D = 7.0E-06 + 4.859E-09*T + 1.341833333333333E-17*T^3 - 3.3795E-13*T^2 - 2.0878475E-22*T^4;
V8D = 4.859E-09 + 4.0255E-17*T^2 - 6.759E-13*T - 8.35139E-22*T^3;
...
DETJ = L7*cos(Q5)*(sin(Q1)*sin(Q3-Q7)+sin(Q3)*sin(Q1-Q7)) - L7*sin(Q5)*(cos(Q1)*sin(Q3-Q7)+cos(Q3)*sin(Q1-Q7)) - sin(Q1-Q3)*(sin(Q5)*(L7*cos(Q7)+L8*sin(Q7))-L7*sin(Q5-Q7)-cos(Q5)*(L7*sin(Q7)-L8*cos(Q7)));

Output(1)=T;  Output(2)=Q7;  Output(3)=Q8;  Output(4)=Q9;  Output(5)=U7;  Output(6)=U8;  Output(7)=U9;  Output(8)=FB;  Output(9)=FD;  Output(10)=FF;  Output(11)=DETJ;
Output(12)=0.0;
  Output(13)=0.0;
  Output(14)=0.0;
  Output(15)=0.0;
...
fprintf( 1, '\n Output is in the files cellsimplifiedmodv4_autolev_2_matlab.i  (i=1,2)\n' );
fprintf( 1, ' The output quantities and associated files are listed in the file cellsimplifiedmodv4_autolev_2_matlab.dir\n' );
fprintf( 1, '\n To load and plot columns 1 and 2 with a solid line and columns 1 and 3 with a dashed line, enter:\n' );
fprintf( 1, '    someName = load( ''cellsimplifiedmodv4_autolev_2_matlab.1'' );\n' );
